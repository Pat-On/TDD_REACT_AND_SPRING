...
describe("apiCalls", () => {
  ...
  describe("loadOldHoaxes", () => {
    ...
    it("calls /api/1.0/users/user3/hoaxes/5?direction=before&page=0&size=5&sort=id,desc when hoax id and username provided", () => {
      const mockGetHoaxes = jest.fn();
      axios.get = mockGetHoaxes;
  ...
  describe("loadNewHoaxes", () => {
    it("calls /api/1.0/hoaxes/5?direction=after&sort=id,desc when hoax id provided", () => {
      const mockGetHoaxes = jest.fn();
      axios.get = mockGetHoaxes;
    ...
    it("calls /api/1.0/users/user3/hoaxes/5?direction=after&sort=id,desc when hoax id and username provided", () => {
      const mockGetHoaxes = jest.fn();
      axios.get = mockGetHoaxes;
  ...
  describe("loadNewHoaxCount", () => {
    it("calls /api/1.0/hoaxes/5?direction=after&count=true when hoax id provided", () => {
      const mockGetHoaxes = jest.fn();
      axios.get = mockGetHoaxes;
    ...
    it("calls /api/1.0/users/user3/hoaxes/5?direction=after&count=true when hoax id and username provided", () => {
      const mockGetHoaxes = jest.fn();
      axios.get = mockGetHoaxes;
