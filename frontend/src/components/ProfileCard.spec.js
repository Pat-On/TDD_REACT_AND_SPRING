...
describe("ProfileCard", () => {
  describe("Layout", () => {
    it("displays the displayNames@username", () => {
    ...
    it("displas label for displayName in edit mode", () => {
      const { container } = render(
        <ProfileCard user={user} inEditMode={true} />
      );
    ...
    it("hides the edit button in edit mode and isEdtable provided as true", () => {
      const { queryByText } = render(
